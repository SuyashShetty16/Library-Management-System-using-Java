...
import com.github.menglim.dbutils.DbUtils;
...
public class statistics extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 680, 132));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 260, 680, 131));

        jButton1.setBackground(new java.awt.Color(255, 255, 204));
        jButton1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jButton1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Suyash\\OneDrive\\Documents\\icon\\red-x-mark-transparent-background-3 (1).png")); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon("C:\\Users\\Suyash\\OneDrive\\Documents\\icon\\123456.png")); // NOI18N
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try
        {
            ...
            */
            ...
            String sql = "select issue.studentID,student.name,issue.bookID,book.name,issue.issueDate,issue.dueDate from student inner join book inner join issue where book.bookID=issue.bookID and student.studentID=issue.studentID and issue.returnBook='NO'";
            ...
            String sql1 = "select issue.studentID,student.name,issue.bookID,book.name,issue.issueDate,issue.dueDate from student inner join book inner join issue where book.bookID=issue.bookID and student.studentID=issue.studentID and issue.returnBook='YES'";
            ...
            while (resultSet1.next()) {
                ...
                for (int i = 1; i <= columns; i++) {
                    row1.addElement(resultSet1.getObject(i));
                }
            ...
            frame1.add(panel1);         //adding panel to the frame
            frame1.setSize(1000, 600); //setting frame size
